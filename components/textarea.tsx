...
export function Textarea({
  ...
  const styles = cn(
    "bg-transparent hover:bg-secondary/25 rounded-xl py-3.5 px-4 resize-none w-full flex items-center border border-secondary ring-4 ring-transparent bg-background text-base font-normal placeholder:text-foreground/50 text-black outline-none focus-within:outline-none hover:bg-transparent focus:bg-transparent hover:border-primary focus:border-primary hover:ring-primary/10 focus:ring-primary/10 transition-all duration-200",
